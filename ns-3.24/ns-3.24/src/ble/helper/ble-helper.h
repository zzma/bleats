...
public:
  ...
  /**
   * \brief Create a Ble helper in an empty state with either a
   ...
   */
  BleHelper (bool useMultiModelSpectrumChannel);
  ...
  /**
   * \brief Install a BleNetDevice and the associated structures (e.g., channel) in the nodes.
  ...
  /**
   * \brief Transform the BlePhyEnumeration enumeration into a printable string.
   * \param e the BlePhyEnumeration
   * \return a string
   */
  static std::string BlePhyEnumerationPrinter (BlePhyEnumeration e);

  /**
   * \brief Transform the BleMacState enumeration into a printable string.
   * \param e the BleMacState
   * \return a string
   */
  static std::string BleMacStatePrinter (BleMacState e);
