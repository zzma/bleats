 ...
 */
typedef Callback<void, BleMacState> BleMacStateCallback;

/**
 * \ingroup ble
 *
 * This class is a helper for the BleMac to manage the Csma/CA
 * state machine according to IEEE 802.15.4-2006, section 7.5.1.4.
 */
class BleCsmaCa : public Object
{
...
public:
   ...
   */
  void SetBleMacStateCallback (BleMacStateCallback macState);
...
private:
   ...
   */
  BleCsmaCa (BleCsmaCa const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  BleCsmaCa& operator= (BleCsmaCa const &);
   ...
   */
  BleMacStateCallback m_bleMacStateCallback;
