...
BleInterferenceHelper::BleInterferenceHelper (Ptr<const SpectrumModel> spectrumModel)
...
BleInterferenceHelper::~BleInterferenceHelper (void)
{
  m_spectrumModel = 0;
  m_signal = 0;
  m_signals.clear ();
...
bool
BleInterferenceHelper::AddSignal (Ptr<const SpectrumValue> signal)
{
...
bool
BleInterferenceHelper::RemoveSignal (Ptr<const SpectrumValue> signal)
{
  NS_LOG_FUNCTION (this << signal);
...
void
BleInterferenceHelper::ClearSignals (void)
{
...
Ptr<SpectrumValue>
BleInterferenceHelper::GetSignalPsd (void) const
{
  NS_LOG_FUNCTION (this);
