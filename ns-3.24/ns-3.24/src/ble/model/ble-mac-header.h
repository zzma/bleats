...
public:
  ...
  /**
   * Constructor
   * \param bleMacType the header MAC type
   * \param seqNum the sequence number
   */
  BleMacHeader (enum BleMacType bleMacType,      // Data, ACK, Control MAC Header must have
   ...
   */
  enum BleMacType GetType (void) const;
  /**
   ...
   * \param bleMacType the frame type
   */
  void SetType (enum BleMacType bleMacType);
