...
/**
 * \ingroup ble
 * TracedValue callback signature for BleMacState.
 *
 * \param [in] oldValue original value of the traced variable
 * \param [in] newValue new value of the traced variable
 */
  typedef void (* BleMacState)(BleMacState oldValue,
                                  BleMacState newValue);
...
struct McpsDataRequestParams
{
  ...
  BleAddressMode m_srcAddrMode; //!< Source address mode
  BleAddressMode m_dstAddrMode; //!< Destination address mode
...
{
  uint8_t m_msduHandle; //!< MSDU handle
  BleMcpsDataConfirmStatus m_status; //!< The status of the last MSDU transmission
};
 ...
 * \ingroup ble
 *
 * Class that implements the BLE Mac state machine
 */
class BleMac : public Object
{
public:
  /**
   * Get the type ID.
   ...
   */
  void PdDataConfirm (BlePhyEnumeration status);
   ...
   */
  void PlmeCcaConfirm (BlePhyEnumeration status);
   ...
   */
  void PlmeEdConfirm (BlePhyEnumeration status, uint8_t energyLevel);
   ...
   */
  void PlmeGetAttributeConfirm (BlePhyEnumeration status,
   ...
   */
  void PlmeSetTRXStateConfirm (BlePhyEnumeration status);
   ...
   *  @param id the attributed identifier
   */
  void PlmeSetAttributeConfirm (BlePhyEnumeration status,
                                BlePibAttributeIdentifier id);
   ...
   */
  void SetBleMacState (BleMacState macState);
   ...
   */
  BleAssociationStatus GetAssociationStatus (void) const;
   ...
   */
  void SetAssociationStatus (BleAssociationStatus status);
...
private:
  ...
  /**
   * A trace source that fires when the BleMac changes states.
   ...
   * TracedValue.
   */
  TracedCallback<BleMacState, BleMacState> m_macStateLogger;
   ...
   */
  TracedValue<BleMacState> m_bleMacState;

  /**
   * The current association status of the MAC layer.
   */
  BleAssociationStatus m_associationStatus;
