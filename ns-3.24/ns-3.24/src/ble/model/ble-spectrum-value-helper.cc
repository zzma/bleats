...
Ptr<SpectrumModel> g_BleSpectrumModel; //!< Global object used to initialize the Ble Spectrum Model
...
} g_BleSpectrumModelInitializerInstance; //!< Global object used to initialize the Ble Spectrum Model
