...
NS_LOG_COMPONENT_DEFINE ("ble-error-model-test");

class BleErrorDistanceTestCase : public TestCase
{
public:
  BleErrorDistanceTestCase ();
  virtual ~BleErrorDistanceTestCase ();
...
class BleErrorModelTestCase : public TestCase
{
public:
  BleErrorModelTestCase ();
  virtual ~BleErrorModelTestCase ();

private:
  virtual void DoRun (void);
};

BleErrorDistanceTestCase::BleErrorDistanceTestCase ()
...
void
BleErrorDistanceTestCase::Callback (McpsDataIndicationParams params, Ptr<Packet> p)
{
  m_received++;
}

void
BleErrorDistanceTestCase::DoRun (void)
{
  ...
  cb0 = MakeCallback (&BleErrorDistanceTestCase::Callback, this);
...
// ==============================================================================
BleErrorModelTestCase::BleErrorModelTestCase ()
...
void
BleErrorModelTestCase::DoRun (void)
{
...
// ==============================================================================
class BleErrorModelTestSuite : public TestSuite
{
public:
  BleErrorModelTestSuite ();
};

BleErrorModelTestSuite::BleErrorModelTestSuite ()
  : TestSuite ("ble-error-model", UNIT)
{
  AddTestCase (new BleErrorModelTestCase, TestCase::QUICK);
  AddTestCase (new BleErrorDistanceTestCase, TestCase::QUICK);
}

static BleErrorModelTestSuite bleErrorModelTestSuite;
